  ...
  return (
    <div ref={containerRef} className={`relative ${isMobile ? "w-full" : "w-64"}`}>
      ...
      {open && query.trim().length > 0 && (
        <div className="absolute left-0 right-0 top-full mt-2 z-[70] rounded-xl bg-white shadow-2xl border border-border overflow-hidden max-h-[70vh] overflow-y-auto">
          {results.length === 0 ? (
