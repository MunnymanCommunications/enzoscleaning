...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-secondary text-secondary-foreground">
      {/* Subtle glass orbs in the background */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-20 -right-20 h-[300px] w-[300px] rounded-full bg-primary/10 blur-3xl" />
        <div className="absolute bottom-0 -left-20 h-[200px] w-[200px] rounded-full bg-accent/8 blur-3xl" />
      </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <div className="flex gap-3">
              <a href="https://www.facebook.com/EnzosCleaning" target="_blank" rel="noopener noreferrer" className="rounded-full bg-secondary-foreground/10 p-3 hover:bg-primary hover:scale-110 transition-all duration-300" aria-label="Facebook">
              ...
              <a href="https://www.youtube.com/channel/UCBwyiTH6Acs0ubiRf10S2Ng" target="_blank" rel="noopener noreferrer" className="rounded-full bg-secondary-foreground/10 p-3 hover:bg-primary hover:scale-110 transition-all duration-300" aria-label="YouTube">
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-wrap gap-2">
                {["Hotsy", "Mi-T-M", "Kärcher", "Vital Oxide"].map((p) => (
                  <span key={p} className="text-xs bg-secondary-foreground/10 rounded-full px-3 py-1 backdrop-blur-sm">{p}</span>
                ))}
              </div>
            </div>
          </motion.div>
      ...
      <div className="relative border-t border-secondary-foreground/10">
