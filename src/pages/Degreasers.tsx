...
const degreasers = [
  ...
  { name: "Rig Cleaner", bullets: ["Heavy-duty rig and equipment degreaser", "Formulated for oilfield and industrial applications", "Removes drilling mud, crude oil and hydraulic fluid", "Safe on metal surfaces and painted equipment"] },
