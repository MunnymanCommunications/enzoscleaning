  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        enzo: {
          blue: "hsl(var(--enzo-blue))",
          "dark-blue": "hsl(var(--enzo-dark-blue))",
          green: "hsl(var(--enzo-green))",
          "light-gray": "hsl(var(--enzo-light-gray))",
          dark: "hsl(var(--enzo-dark))",
          warm: "hsl(var(--enzo-warm))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
